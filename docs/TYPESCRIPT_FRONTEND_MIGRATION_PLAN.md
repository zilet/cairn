...
Updated integration note: `03-today.js`, `02-ui.js`, `04-capture.js`, `07-me-health.js`, `08-me-records.js`, and `09-plan-chat.js` are still stable public compatibility filenames, but more runtime responsibility now lives in smaller generated modules loaded before those consumers. `public/js/10-boot.js` remains the tiny final startup shim; every other served client script should stay build-owned. Current top source-size targets are `today-screen.ts` (832 lines), `me-health-dependencies.ts` (387), `me-health-screen.ts` (386), `me-records-screen.ts` (366), `ui-shell.ts` (341), `coach-meals-screen.ts` (335), `health-client.ts` (331), `progress-chart-client.ts` (327), `meal-plan-client.ts` (326), `progress-screen.ts` (323), `meal-swap-controller.ts` (315), `chat-turn-client.ts` (314), `agent-login-client.ts` (313), `capture-reads-client.ts` (303), `meal-planner-controller.ts` (300), `today-session-controller.ts` (297), `today-plan-session-preparation.ts` (296), `agent-job-client.ts` (291), `progress-history-client.ts` (289), `today-rail-controller.ts` (288), `capture.ts` (284), `exercise-detail-controller.ts` (277), `chat-screen.ts` (277), `life-controller.ts` (275), `meal-recipe-controller.ts` (271), `health-read-client.ts` (268), `health-doc-actions-controller.ts` (265), `settings-screen.ts` (257), `plan-editor-controller.ts` (256), `health-markers-client.ts` (256), and `health-read-controller.ts` (252). `src/client/today-brief-controller.ts` is now 247 lines after action ownership moved out, `src/client/plan-endurance-client.ts` is now 232 lines after model/render ownership moved out, and `src/client/me-records-health-doc-controller.ts` is now 157 lines after document-row action ownership moved out. `me-health-dependencies.ts` is large by design after centralizing dependency composition; future work should split it only when a cohesive sub-context emerges, not by arbitrary line count. Future work should keep extracting cohesive controller/render/data modules from the remaining large files, not edit generated public output directly.
