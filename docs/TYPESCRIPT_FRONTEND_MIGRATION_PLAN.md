...
- [ ] Expand the automated browser workflow lane for deeper Today log set/skip/cardio, Chat send/stream/reconnect, Health marker/records, Settings Data, Plan, and Progress interactions.
