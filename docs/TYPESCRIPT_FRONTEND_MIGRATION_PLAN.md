...
Latest Today rail split: `src/client/today-week-ahead-client.ts` owns the week-ahead glyphs, rows, card summary, and escaping while `src/client/today-screen.ts` keeps only `/week-ahead` loading and slot wiring.
