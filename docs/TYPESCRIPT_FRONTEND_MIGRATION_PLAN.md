...
- [ ] Shrink the remaining large typed screen/controllers (`today-screen`, `me-health-screen`, `ui-shell`, `today-brief-controller`, `chat-turn-client`, `today-session-controller`, `chat-screen`, `progress-chart-client`, `progress-screen`, `meal-swap-controller`, `me-records-screen`, `me-profile-controller`, `health-standing-client`, `plan-editor-controller`, `capture`, `coach-meals-screen`, `plan-endurance-client`, `me-records-health-doc-controller`, `health-client`, `meal-plan-client`, `health-read-controller`, `agent-login-client`, `capture-reads-client`, and `meal-planner-controller`) into smaller responsibility modules.
