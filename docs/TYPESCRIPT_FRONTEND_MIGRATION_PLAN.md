...
- [ ] Shrink the remaining large typed screen/controllers (`today-screen`, `me-health-screen`, `chat-screen`, `ui-shell`, `chat-turn-client`, `progress-chart-client`, `progress-screen`, `meal-swap-controller`, `me-records-screen`, `today-brief-controller`, `me-profile-controller`, `health-standing-client`, `plan-editor-controller`, `capture`, `coach-meals-screen`, `plan-endurance-client`, `me-records-health-doc-controller`, `health-client`, `meal-plan-client`, `agent-login-client`, `capture-reads-client`, `meal-planner-controller`, `today-session-controller`, `today-plan-session-preparation`, `today-rail-controller`, `life-controller`, `meal-recipe-controller`, `health-read-client`, `settings-screen`, `health-markers-client`, `progress-history-client`, and `health-read-controller`) into smaller responsibility modules.
