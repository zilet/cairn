...
TypeScript-frontend checkout, run the client/public deploy guard so browser-client buildability,
classic-script global collisions, and service-worker cache drift are caught locally:
