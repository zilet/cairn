...
export * from "./repo/exercise-dedupe.js"; // the re-runnable duplicate/alias fold (migration 103 ran it once)
...
export * from "./repo/movement-considerations.js"; // stated lasting, painless conditions — prompt context, never a gate
...
export * from "./repo/surface-dismissals.js"; // dismissals as evidence: repetition-gated (never one tap)
