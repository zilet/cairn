...
// ---- cache warm-up ----
// Mirrors public/app.js ACT_ART_PHRASE and MUST stay in sync with it: bare
...
export function warmArt(): { queued: number; skipped: number } {
  ...
  //    Query built exactly like public/app.js mealRowHtml.
  ...
  // c) food notes — same fallback chain as public/app.js noteEntryInner.
