...
function progressChartTracePath(
...
function drawProgressChartBase(
  ctx: CanvasRenderingContext2D,
...
function drawProgressChartHighlight(ctx: CanvasRenderingContext2D, args: ProgressChartHighlightOptions): void {
