// @ts-check
// Pure Plan editor render/model helpers. The screen keeps data loading, save-bar,
// event wiring, and persistence in 09-plan-chat.js.
...
function dayModelFromPlan(day: PlanEditorDay): Required<Pick<PlanEditorDay, "day_number" | "name" | "focus" | "items">> {
  return {
