...
type HealthMarkerOrderRow = { name?: unknown; key?: unknown; latest?: { date?: unknown } | null };
...
function orderMarkersForDisplay<T extends HealthMarkerOrderRow>(groupKey: unknown, list: T[] | null | undefined): T[] {
...
function lipidGroupNoteHtml(
  list: HealthMarkerOrderRow[] | null | undefined,
