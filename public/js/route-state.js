...
// @ts-check
/**
 * @typedef {import("../../src/contracts/client.js").ClientRoute} CairnRoute
 * @typedef {import("../../src/contracts/client.js").ClientRoutesApi} CairnRoutesApi
 */
/**
 * @param {typeof globalThis & { CairnRoutes?: CairnRoutesApi }} root
 */
(function initCairnRoutes(root) {
  ...
  /** @param {unknown} value @param {Set<string>} allowed @param {string | null} [fallback] */
  ...
  /** @param {string | URL} input @returns {CairnRoute} */
  ...
  /** @param {Partial<CairnRoute> | null | undefined} route */
...
})(/** @type {typeof globalThis & { CairnRoutes?: CairnRoutesApi }} */ (typeof window !== "undefined" ? window : globalThis));
