...
/**
 * @typedef {RequestInit & { headers?: Record<string, string> }} CairnApiOptions
 */

/**
 * @template {string} Path
 * @typedef {import("../../src/contracts/client.js").ClientApiResponse<Path>} CairnApiResponse
 */
 ...
 * @template {string} Path
 * @param {Path} p
 * @param {CairnApiOptions} [opts]
 * @returns {Promise<CairnApiResponse<Path>>}
 */
function api(p, opts = {}) {
  const t = authToken();
