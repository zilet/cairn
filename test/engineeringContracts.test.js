...
test("frontend TypeScript contract gate is dependency-light and backed by server payloads", () => {
  ...
  assert.ok(
    index.indexOf("/js/progress-endurance-client.js") > index.indexOf("/js/today-context-client.js") &&
  ...
  assert.ok(
    index.indexOf("/js/health-directives-loader-client.js") > index.indexOf("/js/health-directives-client.js") &&
      index.indexOf("/js/health-directives-loader-client.js") < index.indexOf("/js/08-me-records.js"),
    "health-directives-loader-client.js must load after directive render helpers and before boot can render Health Read"
  );
  assert.ok(
    index.indexOf("/js/health-learned-client.js") > index.indexOf("/js/health-directives-loader-client.js") &&
  ...
  assert.ok(
    index.indexOf("/js/chat-attachment-client.js") > index.indexOf("/js/chat-client.js") &&
      index.indexOf("/js/chat-attachment-client.js") < index.indexOf("/js/chat-turn-client.js"),
    "chat-attachment-client.js must load after chat helpers and before chat turn helpers"
  );
  assert.ok(
    index.indexOf("/js/chat-turn-client.js") > index.indexOf("/js/chat-attachment-client.js") &&
      index.indexOf("/js/chat-turn-client.js") < index.indexOf("/js/09-plan-chat.js"),
    "chat-turn-client.js must load after chat attachment helpers and before 09-plan-chat.js"
  );
  assert.ok(
  ...
  assert.match(health, /CairnHealthDirectiveLoader\.load\(pollToken\)/);
