...
test("Settings route helper exposes stale-route pruning", () => {
  ...
  assert.ok(
    ...
    "Settings route/surface helpers must load before the Settings Agents controller and Settings screen"
  );
});
...
test("PWA route state is wired through boot, tabs, nested screens, and date-aware fuel", () => {
  ...
  assert.match(health, /CairnMeHealthTabsController\.renderHealth\(meHealthTabsDeps\(\)\)/);
...
test("PWA route literals stay aligned across parser, types, and segment registries", () => {
  ...
  assert.match(meHealth, /const HEALTH_SEG = CairnMeHealthTabsController\.HEALTH_SEG/);
...
test("frontend TypeScript contract gate is dependency-light and backed by server payloads", () => {
  ...
  assert.ok(
    ...
    "today-rail-controller.js must load after agenda helpers and before Today"
  );
  assert.ok(
  ...
  assert.ok(
    index.indexOf("/js/today-plan-session-preparation.js") > index.indexOf("/js/today-side-loaders.js") &&
      index.indexOf("/js/today-plan-session-preparation.js") < index.indexOf("/js/today-post-render-wiring.js"),
    "today-plan-session-preparation.js must load after Today side loaders and before post-render wiring"
  );
  assert.ok(
    index.indexOf("/js/today-post-render-wiring.js") > index.indexOf("/js/today-plan-session-preparation.js") &&
      index.indexOf("/js/today-post-render-wiring.js") < index.indexOf("/js/03-today.js"),
    "today-post-render-wiring.js must load after Today preparation and before 03-today.js"
  );
  assert.ok(
  ...
  assert.ok(
    index.indexOf("/js/today-brief-override-client.js") > index.indexOf("/js/today-brief-client.js") &&
      index.indexOf("/js/today-brief-override-client.js") < index.indexOf("/js/today-brief-controller.js"),
    "today-brief-override-client.js must load after Today brief helpers and before Today brief controller"
  );
  assert.ok(
    index.indexOf("/js/today-brief-controller.js") > index.indexOf("/js/today-brief-override-client.js") &&
      index.indexOf("/js/today-brief-controller.js") < index.indexOf("/js/03-today.js"),
    "today-brief-controller.js must load after Today brief override helpers and before 03-today.js"
  );
  assert.ok(
  ...
  assert.ok(
    index.indexOf("/js/today-session-skip-client.js") > index.indexOf("/js/today-session-feedback-client.js") &&
      index.indexOf("/js/today-session-skip-client.js") < index.indexOf("/js/today-session-controller.js"),
    "today-session-skip-client.js must load after session-feedback helpers and before session controller"
  );
  assert.ok(
    index.indexOf("/js/today-session-controller.js") > index.indexOf("/js/today-session-skip-client.js") &&
      index.indexOf("/js/today-session-controller.js") < index.indexOf("/js/03-today.js"),
    "today-session-controller.js must load after session-skip helpers and before Today"
  );
  assert.ok(
  ...
  assert.ok(
    index.indexOf("/js/progress-endurance-client.js") > index.indexOf("/js/today-post-render-wiring.js") &&
      index.indexOf("/js/progress-endurance-client.js") < index.indexOf("/js/05-progress.js"),
    "progress-endurance-client.js must load after Today helper wiring and before Progress consumers"
  );
  assert.ok(
  ...
  assert.ok(
    index.indexOf("/js/progress-line-chart-model.js") > index.indexOf("/js/progress-components-client.js") &&
      index.indexOf("/js/progress-line-chart-model.js") < index.indexOf("/js/progress-chart-client.js"),
    "progress-line-chart-model.js must load after Progress components and before the chart renderer"
  );
  assert.ok(
    index.indexOf("/js/progress-chart-client.js") > index.indexOf("/js/progress-line-chart-model.js") &&
  ...
  assert.ok(
    index.indexOf("/js/progress-run-plan-client.js") > index.indexOf("/js/progress-history-client.js") &&
      index.indexOf("/js/progress-run-plan-client.js") < index.indexOf("/js/progress-endurance-controller.js"),
    "progress-run-plan-client.js must load before Progress Endurance consumers"
  );
  assert.ok(
    index.indexOf("/js/progress-endurance-controller.js") > index.indexOf("/js/progress-run-plan-client.js") &&
  ...
  assert.ok(
    index.indexOf("/js/capture-reads-client.js") > index.indexOf("/js/capture-provenance-client.js") &&
      index.indexOf("/js/capture-reads-client.js") < index.indexOf("/js/04-capture.js"),
    "capture-reads-client.js must load after Capture provenance and before Capture consumers"
  );
  assert.ok(
    index.indexOf("/js/04-capture.js") > index.indexOf("/js/capture-reads-client.js") &&
      index.indexOf("/js/04-capture.js") < index.indexOf("/js/05-progress.js"),
    "04-capture.js must load after Capture reads and before downstream screens"
  );
  assert.ok(
  ...
  assert.ok(
    index.indexOf("/js/meal-recipe-controller.js") > index.indexOf("/js/meal-recipe-client.js") &&
      index.indexOf("/js/meal-recipe-controller.js") < index.indexOf("/js/meal-swap-controller.js"),
    "meal-recipe-controller.js must load before Meal Swap controller"
  );
  assert.ok(
    index.indexOf("/js/meal-swap-controller.js") > index.indexOf("/js/meal-recipe-controller.js") &&
  ...
  assert.ok(
    ...
    "chat-message-client.js must load after chat composer focus helpers and before chat turn record helpers"
  );
  assert.ok(
  ...
  assert.ok(
    index.indexOf("/js/chat-turn-stream-state-client.js") > index.indexOf("/js/chat-turn-records-client.js") &&
      index.indexOf("/js/chat-turn-stream-state-client.js") < index.indexOf("/js/chat-turn-client.js"),
    "chat-turn-stream-state-client.js must load after chat turn record helpers and before chat turn helpers"
  );
  assert.ok(
    index.indexOf("/js/chat-turn-client.js") > index.indexOf("/js/chat-turn-stream-state-client.js") &&
      index.indexOf("/js/chat-turn-client.js") < index.indexOf("/js/09-plan-chat.js"),
    "chat-turn-client.js must load after chat turn stream-state helpers and before 09-plan-chat.js"
  );
  assert.ok(
  ...
  assert.ok(
    index.indexOf("/js/me-profile-controller.js") > index.indexOf("/js/health-docs-client.js") &&
      index.indexOf("/js/me-profile-controller.js") < index.indexOf("/js/07-me-health.js"),
    "me-profile-controller.js must load after shared Health document helpers and before Me Profile consumers"
  );
  assert.ok(
    index.indexOf("/js/me-health-tabs-controller.js") > index.indexOf("/js/me-profile-controller.js") &&
      index.indexOf("/js/me-health-tabs-controller.js") < index.indexOf("/js/07-me-health.js"),
    "me-health-tabs-controller.js must load before Me Health screen consumers"
  );
  assert.ok(
  ...
  assert.match(todayPlanSessionPreparationSource, /function groupLoggedSets\(session: TodayPlanSessionPrepSession \| null \| undefined\)/);
  assert.match(todayPlanSessionPreparationSource, /function matchCardioEfforts\(/);
  ...
  assert.match(progressScreenSource, /function progressProgramDeps\(\): ClientProgressProgramControllerDeps/);
  assert.match(progressScreenSource, /CairnProgressProgramController\.render\(progressProgramDeps\(\)\)/);
  ...
  assert.match(settingsScreenSource, /CairnSettingsSurface\.sourcesSliceHtml/);
  assert.match(settingsScreenSource, /CairnSettingsSurface\.automationSliceHtml/);
  ...
  assert.match(chatScreenSource, /CairnChatAttachment\.resetFocusAfterNativePicker/);
  ...
  assert.match(mealPlannerControllerSource, /function reconnectMealPlan\(\): ClientAgentOpHandlers \| null/);
  assert.match(mealPlannerControllerSource, /CairnMealSwapController\.wireMealRows/);
  assert.doesNotMatch(mealPlannerControllerSource, /function submitMealSwap|function mealSwapOpOpts|function reconnectMealSwap|function moveMealRow|function wireMealRows|CairnMealRecipeController\.openMealSheet/);
  ...
  assert.doesNotMatch(coachMealsScreenSource, /function openMealSheet|function recipeOpOpts|function reconnectRecipe|function reconnectMealPlan|function reconnectMealSwap|function wireMealRows|function draftWeeklyMeals/);
  ...
  assert.match(meHealthScreenSource, /function meMemoryDeps\(\): ClientMeMemoryControllerDeps/);
  ...
  assert.match(lifeControllerSource, /async function load\(deps: ClientLifeControllerDeps\): Promise<void>/);
  assert.match(lifeControllerSource, /function startEdit\(card: HTMLElement \| null, deps: ClientLifeControllerDeps\): void/);
  assert.match(lifeControllerSource, /function startDelete\(button: Element, deps: ClientLifeControllerDeps\): void/);
  ...
  assert.match(meProfileControllerSource, /type MeProfileControllerDeps = \{/);
  assert.match(meProfileControllerSource, /function profileHtml\(/);
  ...
  assert.match(meHealthScreenSource, /function meHealthTabsDeps\(\): ClientMeHealthTabsControllerDeps/);
  assert.match(meHealthScreenSource, /CairnMeHealthTabsController\.renderHealth\(meHealthTabsDeps\(\)\)/);
  assert.match(meHealthScreenSource, /function switchHealthSeg\(seg: ClientHealthSection, opts: \{ openPicker\?: boolean \} = \{\}\): void/);
  assert.match(meHealthScreenSource, /CairnMeHealthTabsController\.switchHealthSeg\(seg, meHealthTabsDeps\(\), opts\)/);
  assert.match(meHealthScreenSource, /function healthPictureDeps\(\)/);
  assert.match(meHealthScreenSource, /CairnHealthPictureController\.getHealthPictureCache/);
  assert.match(meHealthScreenSource, /CairnHealthPictureController\.setHealthPictureCache/);
  assert.match(meHealthScreenSource, /CairnHealthPictureController\.paintHealthPicture/);
  assert.match(meHealthScreenSource, /CairnHealthPictureController\.loadHealthPicture/);
  ...
  assert.match(today, /todaySideLoaders\.garminSessionCard/);
  ...
  assert.doesNotMatch(mealPlannerController, /function reconnectMealSwap|function wireMealRows|function mealSwapOpOpts/);
  ...
  assert.match(lifeController, /CairnLife\.lifeEventHtml/);
  assert.match(lifeController, /CairnLife\.lifeFieldsHtml/);
  ...
  assert.match(today, /CairnTodayCards\.exerciseCardHtml/);
  assert.match(today, /CairnTodayCards\.cardioPlanCardHtml/);
  ...
  assert.match(today, /todaySideLoaders\.loadContextBanner/);
  assert.match(today, /todaySideLoaders\.loadHealthFocusBanner/);
  ...
  assert.match(mealPlannerController, /function reconnectMealPlan\(\)/);
  assert.match(mealSwapController, /function reconnectMealSwap\(job\)/);
  ...
  assert.match(lifeController, /CairnLife\.lifeEventHtml/);
  assert.match(lifeController, /CairnLife\.lifeFieldsHtml/);
  assert.match(lifeController, /api\("\/context-events"/);
